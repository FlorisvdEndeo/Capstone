...
hamiltonian += QubitOperator("", -0.81261)
hamiltonian += QubitOperator("Z0",  0.171201)
hamiltonian += QubitOperator("Z1", 0.16862325)
hamiltonian += QubitOperator("Z2", -0.2227965)
hamiltonian += QubitOperator("Z1 Z0",  0.171201)
hamiltonian += QubitOperator("Z2 Z0", 0.12054625)
hamiltonian += QubitOperator("Z3 Z1", 0.17434925)
hamiltonian += QubitOperator("X2 Z1 X0", 0.04532175)
hamiltonian += QubitOperator("Y2 Z1 Y0", 0.04532175)
hamiltonian += QubitOperator("Z2 Z1 Z0", 0.165868)
hamiltonian += QubitOperator("Z3 Z2 Z0", 0.12054625)
hamiltonian += QubitOperator("Z3 Z2 Z1", -0.2227965)
hamiltonian += QubitOperator("Z3 X2 Z1 X0", 0.04532175)
hamiltonian += QubitOperator("Z3 Y2 Z1 Y0", 0.04532175)
hamiltonian += QubitOperator("Z3 Z2 Z1 Z0", 0.165868)
